...
def create_mistral_batch_upload(input_filename, output_filename):
...
create_mistral_batch_upload(r".\data_nb\Nationality_nb_prompts.jsonl", r".\data_nb\Nationality_nb_mistral_batch.jsonl")